...
This package has **zero coupling** to `hallberg2025.seq.data` (the sequencing/FACETS/trellis
...
- The published `methylation_se` is, for now, still served from
  `hallberg2025.base/data/methylation_se.rda` in the base package. Migrating callers to
...
zero-coupling boundary with `hallberg2025.seq.data`).
